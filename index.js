...
// ==========================================
  // 3. АВТО-ГРУПУВАННЯ ПО СПЕЦІАЛЬНОСТЯХ
  // ==========================================
  ...
  docData.forEach(docItem => {
    if(docItem.main_way && docItem.main_way.length > 0) {
      docItem.main_way.forEach(spec => {
        ...
        // Додаємо лікаря у відповідну категорію
  ...
  if (specSheet) {
    ...
    // Формуємо текст для кожної спеціальності
    ...
    console.log("Лист specialties_summary не знайдено, пропускаємо цей крок.");
  }
